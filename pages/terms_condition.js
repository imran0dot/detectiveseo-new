...
const terms_condition = () => {
    return <Layouts pageTitle="Terms & Conditions">
        <Head>
            <title>DetectiveSEO | Terms & Conditions</title>

        </Head>
        <section className="blog-area p-t-130 p-b-130 terms">
            {/* Introduction */}
            ...
            <div className="container">
                <h1 className='text-center my-5'>Use of Website</h1>

                <h4>Eligibility</h4>
                <p>To use our website, you must be at least 18 years old and have the legal capacity to enter into binding contracts.
                </p>
                
                <h4>License</h4>
                <p>We grant you a limited, non-exclusive, non-transferable, and revocable license to use our website for personal and commercial purposes in accordance with these Terms and Conditions.
                </p>
            ...
            <div className="container">
                ...
                <p>All content on this website, including text, graphics, logos, and software, is the property of Detective SEO or its content suppliers and is protected by international copyright laws. You may not reproduce, distribute, or create derivative works from our content without our explicit permission.
                </p>
                ...
                <p>We reserve the right to modify these Terms and Conditions at any time. Any changes will be effective immediately upon posting on our website. Your continued use of our website following the posting of revised Terms and Conditions means that you accept and agree to the changes.
                </p>

                <h4>Governing Law</h4>
                <p>These Terms and Conditions are governed by and construed in accordance with the laws of Dhaka,Bangladesh, without regard to its conflict of law principles. You agree to submit to the exclusive jurisdiction of the courts located in Balla Bazar, Kalihati, Tangail for the resolution of any disputes.
                </p>
