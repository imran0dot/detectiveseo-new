    ...
    return (
        <Layouts pageTitle={"Privacy Policy"}>
            ...
            <section className='container py-5 terms-container'>
                <h1 className='text-center my-5 terms-title'>Privacy Policy</h1>
                <h4>Introduction:</h4>
                ...
                <h1 className='text-center my-5 terms-title'>Information We Collect</h1>
                ...
                <ul>
                    <li><span>The Right to Access:</span> You have the right to request copies of your personal data.</li>
